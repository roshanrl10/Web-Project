  ...
  return (
    <div className="loginsignup-wrap">
      <div className="loginsignup-html">
        ...
        />
        <label htmlFor="tab-1" className="loginsignup-tab">
          Sign In
        </label>
        ...
        />
        <label htmlFor="tab-2" className="loginsignup-tab">
          Sign Up
        </label>
          ...
          {isLogin ? (
            <form onSubmit={handleSubmit} className="loginsignup-sign-in-htm">
              <div className="loginsignup-group">
                <label htmlFor="email" className="loginsignup-label">
                  Email
                </label>
                <input
                  id="email"
              ...
              <div className="loginsignup-group">
                <label htmlFor="password" className="loginsignup-label">
                  Password
                </label>
                <input
                  id="password"
            ...
            <form onSubmit={handleSubmit} className="loginsignup-sign-up-htm">
              <div className="loginsignup-group">
                <label htmlFor="username" className="loginsignup-label">
                  Username
                </label>
                <input
                  id="username"
              ...
              <div className="loginsignup-group">
                <label htmlFor="fullname" className="loginsignup-label">
                  Fullname
                </label>
                <input
                  id="fullname"
              ...
              <div className="loginsignup-group">
                <label htmlFor="contact" className="loginsignup-label">
                  Contact Number
                </label>
                <input
                  id="contact"
          ...
          <div className="forgot-password-modal">
            <div className="forgot-password-content">
              ...
              <form onSubmit={handleForgotPasswordSubmit}>
                ...
                <div className="loginsignup-group">
                  <label htmlFor="newPassword" className="loginsignup-label">
                    New Password
                  </label>
                  <input
                    id="newPassword"
                ...
                <div className="loginsignup-group">
                  <button
                    type="button"
                    className="loginsignup-button cancel"
