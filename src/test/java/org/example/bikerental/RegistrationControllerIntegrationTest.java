...
public class RegistrationControllerIntegrationTest {
    ...
    public void testSaveRegistration() {
        ...
        ResponseEntity<String> response = restTemplate.postForEntity("/registration/save", registrationPojo,
                String.class);
    ...
    public void testGetRegistrationById() {
        ...
        if (entity.isPresent()) {
            ResponseEntity<RegistrationEntity> response = restTemplate.getForEntity("/registration/list/1",
